...
for i in daily_transactions:
    daily_transactions_split.append(i)
...
transactions_clean = [transactions_clean.strip(' ') for transactions_clean in daily_transactions_split]
...
transactions_clean2 = [transactions_clean2.strip(' ') for transactions_clean2 in sales]
transactions_clean3 = [transactions_clean3.strip('$') for transactions_clean3 in transactions_clean2]

for e in transactions_clean3:
   print(transactions_clean3)
   try:
      total_sales += float(e)
   except:
      print("invalid inout")
...
thread_sold_clean = [thread_sold_clean.strip(' ') for thread_sold_clean in thread_sold]



#the instructions is incorrect about how many times the color is sold 
def color_count(color):
   count = 0
   for e in thread_sold_clean:
    try:
      if e == color:
        print(e)
        count += 1
